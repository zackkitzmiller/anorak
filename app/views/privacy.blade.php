	...
	<div class="container">
		<div class='row'>
			<div class='col-md-12'>
				...
				<ul>
					<li>Cookies are required to use the Anorak service.</li>
				...
				<p>Anorak may disclose personally identifiable information under special circumstances, such as to comply with subpoenas or when your actions violate the Terms of Service.</p>

				<h2>Changes</h2>

				<p>Anorak may periodically update this policy. We will notify you about significant changes in the way we treat personal information by sending a notice to the primary email address specified in your Anorak account or by placing a prominent notice on our site.</p>

				<h2>Questions</h2>

				<p>Any questions about the Privacy Policy should be addressed to <a href='https://twitter.com/anorakci'>@anorakci</a></p>
			</div>
		</div>
	</div>
</section>
